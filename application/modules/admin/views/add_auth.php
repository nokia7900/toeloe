<div id="main">
	...
	<div id="new-post">
		...
		<table border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
				<td id="post-title"><label>User Email</label><br /><input type="text" name="post_email" value="<?php echo set_value('post_email'); ?>" /> <?php echo form_error('post_email', '<span>', '</span>'); ?></td>
			</tr>
			<tr>
